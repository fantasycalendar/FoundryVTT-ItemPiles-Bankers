...
export default () => {
  ...
  return {
    ...
    base: `/modules/${MODULE_NAME}/`,   // Base module path that 30001 / served dev directory.
    ...
    server: {
      ...
      open: false,
      proxy: {
        [`^(/modules/${MODULE_NAME}/languages)`]: 'http://127.0.0.1:30000',
        [`^(?!/modules/${MODULE_NAME}/)`]: 'http://127.0.0.1:30000',
